...
alias gci='f(){ git clone git@code.corp.indeed.com:$(get_dir_name)/$1.git; cd $1; unset -f f; }; f'
alias gciacp='f(){ git clone git@code.corp.indeed.com:$(get_dir_name)/$1.git; cd $1; ant clippy-project; unset -f f; }; f'
