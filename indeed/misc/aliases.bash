...
alias ogf='f(){ DISPLAY=:0 firefox -new-tab -url $GITLAB_BASE_URL/$(basename $(dirname "$PWD"))/$(basename "$PWD")/blob/master/$(find . -name *.java -type f | grep "$1" | cut -c 3-); unset -f f; }; f'
